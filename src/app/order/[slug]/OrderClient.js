...
const categoryIcons = {
  powder: <FaFlask className="w-10 h-10 text-[#f59e0b]" />,
  vape: <FaVial className="w-10 h-10 text-[#f59e0b]" />,
  liquid: <FaTint className="w-10 h-10 text-[#f59e0b]" />,
  flavours: <FaAppleAlt className="w-10 h-10 text-[#f59e0b]" />,
};
    ...
    return (
      <div className="min-h-screen bg-[#fffaf5] flex items-center justify-center px-4">
        <div className="text-center">
          <FiLoader className="w-10 h-10 text-[#f59e0b] animate-spin mx-auto mb-3" />
    ...
    return (
      <div className="min-h-screen bg-[#fffaf5] flex items-center justify-center px-4">
        <div className="text-center">
          ...
          <Link href="/shop" className="text-[#f59e0b] hover:underline">Back to Shop</Link>
        </div>
      </div>
    );
  }
  ...
  if (orderPlaced) {
    return (
      <div className="min-h-screen bg-[#fffaf5] flex items-center justify-center px-4">
        ...
        >
          <div className="bg-white border border-orange-100 rounded-3xl p-10">
            <div className="w-20 h-20 bg-orange-50 rounded-full flex items-center justify-center mx-auto mb-5">
              {orderChannel === "telegram" ? <FaTelegramPlane className="w-10 h-10 text-sky-500" /> : <FaWhatsapp className="w-10 h-10 text-[#f59e0b]" />}
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <a
                ...
                className="inline-flex items-center justify-center gap-2 bg-[#f59e0b] hover:bg-[#ea7a17] text-white font-bold px-8 py-3 rounded-xl transition-all"
              >
              ...
              <Link
                href="/shop"
                className="inline-flex items-center justify-center gap-2 border border-orange-200 hover:border-[#f59e0b] text-gray-700 font-semibold px-8 py-3 rounded-xl transition-all"
              >
    ...
    <div className="min-h-screen bg-[#fffaf5]">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <nav className="flex items-center gap-1.5 text-sm text-gray-500 mb-6">
          ...
          <Link href="/shop" className="hover:text-[#f59e0b] transition-colors">Shop</Link>
          <FiChevronRight className="w-3 h-3" />
          <Link href={`/shop/${product.slug}`} className="hover:text-[#ea7a17] transition-colors truncate max-w-[120px]">{product.name}</Link>
          <FiChevronRight className="w-3 h-3" />
          <span className="text-[#f59e0b] font-medium">Order</span>
        </nav>

        {/* Back link */}
        <Link href={`/shop/${product.slug}`} className="inline-flex items-center gap-1.5 text-sm text-gray-500 hover:text-[#ea7a17] transition-colors mb-6">
        ...
        >
          ...
          <div className="bg-white border border-orange-100 rounded-2xl p-5">
            <div className="flex items-center gap-4">
              <div className="w-16 h-16 bg-orange-50 border border-orange-100 rounded-xl flex items-center justify-center shrink-0 overflow-hidden">
                {product.image ? (
              ...
              <div className="flex-1 min-w-0">
                <p className="text-xs font-semibold text-[#f59e0b] uppercase tracking-wider mb-0.5 capitalize">{product.category}</p>
              ...
              <div className="text-right shrink-0">
                ...
                <p className="text-2xl font-extrabold text-[#f59e0b]">€{currentPrice.toFixed(2)}</p>
              </div>
            </div>
            ...
            <div className="mt-4 pt-4 border-t border-orange-100 flex items-center justify-between">
              ...
              <span className="text-sm font-bold text-[#f59e0b] bg-orange-50 px-3 py-1 rounded-full">
                {sizeLabel}
              </span>
            </div>
          </div>
                  ...
                  <button
                    ...
                    className={`px-4 py-3.5 rounded-xl border text-sm font-medium transition-all text-center ${
                      selectedSize === i
                        ...
                        : "bg-[#fffaf5] text-gray-600 border-orange-200 hover:border-[#f59e0b] hover:bg-orange-50"
                    }`}
                  >
                    <span className="block font-bold">{size.label}</span>
                    <span className={`text-sm mt-0.5 block ${selectedSize === i ? "text-white/80" : "text-[#f59e0b]"}`}>€{size.price.toFixed(2)}</span>
                  </button>
                ))}
              </div>
            </div>
          ...
          <div className="bg-white border border-orange-100 rounded-2xl p-6">
            ...
            <form onSubmit={handleOrder} className="space-y-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  <button
                    ...
                    className={`flex items-center gap-3 rounded-xl border p-4 text-left transition-all disabled:cursor-not-allowed disabled:opacity-50 ${
                      orderChannel === "whatsapp" ? "border-[#f59e0b] bg-orange-50 ring-2 ring-[#f59e0b]/20" : "border-orange-200 bg-white hover:border-[#f59e0b]"
                    }`}
                  >
                  ...
                  <button
                    ...
                    className={`flex items-center gap-3 rounded-xl border p-4 text-left transition-all disabled:cursor-not-allowed disabled:opacity-50 ${
                      orderChannel === "telegram" ? "border-sky-500 bg-sky-50 ring-2 ring-sky-500/20" : "border-orange-200 bg-white hover:border-sky-500"
                    }`}
                  >
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full bg-white border border-orange-200 text-gray-800 rounded-xl pl-10 pr-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-[#f59e0b]/30 focus:border-[#f59e0b] placeholder:text-gray-400"
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <textarea
                    ...
                    className="w-full bg-white border border-orange-200 text-gray-800 rounded-xl pl-10 pr-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-[#f59e0b]/30 focus:border-[#f59e0b] placeholder:text-gray-400 resize-none"
                  />
                </div>
              </div>

              {/* Serious buyer check */}
              <label className="flex items-start gap-3 p-4 rounded-xl bg-orange-50 border border-orange-100 cursor-pointer">
                <input
                  type="checkbox"
                  checked={confirmed}
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-2 bg-[#f59e0b] hover:bg-[#ea7a17] disabled:opacity-60 text-white font-bold py-4 rounded-xl transition-all hover:shadow-lg hover:shadow-orange-200/50 mt-2 text-base"
              >
                {submitting ? (
          ...
          <div className="grid grid-cols-3 gap-3">
            {[
              ...
              <div key={label} className="bg-white border border-orange-100 rounded-xl p-3 flex flex-col items-center gap-1.5">
